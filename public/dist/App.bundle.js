...
//check js30 num 21 to make above lat/lng dynamic
...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        axios.get('/api/search?q=' + this.value).then(function (res) {
            if (res.data.length) {
                ...
                searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__results">No results for ' + _this.value + ' found!');
            }
        }).catch(function (err) {
            console.error(err);
        });
    ...
    searchInput.on('keyup', function (e) {
        //we only care about up, down, enter
